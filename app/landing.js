      ...
      <div className="flex items-center h-full max-w-screen-xl mx-auto px-8">
        <div className="flex-grow space-y-5">
          <div className="flex items-center">
            ...
            <p className="font-serif font-bold text-8xl">study.yt</p>
          </div>
          <p className="font-serif font-bold text-5xl">Skip the lectures, learn the content</p>
        ...
        <div className="flex-shrink-0">
            <Link href="/api/auth/login">
                <button className="font-bold font-serif bg-gradient-to-r from-blue-500 to-blue-600 text-white text-3xl rounded-full w-60 h-16 px-6 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 transform hover:scale-105 transition-transform">
                Get Started
                </button>
            </Link>
        </div>
